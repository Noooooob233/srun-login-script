...
class LoginManager:
	def __init__(self,
		url_login_page = "http://aaa.ncu.edu.cn/srun_portal_pc?ac_id=1&theme=basic1",
		url_get_challenge_api = "http://aaa.ncu.edu.cn/cgi-bin/get_challenge",
		url_login_api = "http://aaa.ncu.edu.cn/cgi-bin/srun_portal",
		n = "200",
		vtype = "1",
		acid = "1",
		enc = "srun_bx1"
	...
	def _get_challenge(self):
		...
		params_get_challenge = {
			"callback": "jQuery112403468076661438977_1621916553141", # This value can be any string, but cannot be absent
	...
	def _send_login_info(self):
		login_info_params = {
			'callback': 'jQuery11240725353372493067_1621913334042', # This value can be any string, but cannot be absent
			'action':'login',
			'username': self.username,
